      ...
      <div class="card p-7">
        ...
        <div class="app-brand justify-content-center mt-5">
          <a href="{{url('/dashboard')}}" class="app-brand-link gap-3">
            <span class="app-brand-logo demo">@include('_partials.giamed',["height"=>20,"withbg"=>'fill: #fff;'])</span>
        ...
        <div class="card-body mt-1">
          ...
          <form id="formAuthentication" class="mb-5" action="{{url('/dashboard')}}" method="GET">
