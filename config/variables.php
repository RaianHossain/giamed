...
// Variables
return [
  "creatorName" => "Raian&Afeef",
  "creatorUrl" => "https://my.portfolio.raianthenoob.xyz/",
  "templateName" => "Giamedical",
  "templateSuffix" => "Dialysis Solutions for Less",
  "templateVersion" => "2.0.0",
  "templateFree" => true,
  "templateDescription" => "GIA Medical is a professional and user-friendly platform designed to provide high-quality dialysis equipment and medical solutions at affordable prices.",
  "templateKeyword" => "GIA Medical, dialysis solutions, medical equipment, healthcare products, kidney care, affordable dialysis, hospital supplies",
